...
# Data
ml_algorithms = ['XGboost',  'CNN',  'AdaBoost', 
                 'Adaptive Decision Learner', 'LSTM', 'GRU', 'Random Forest', 
                 'SVM', 'Logistic Regression']
accuracy_scores = [95.6140,  94.736,  97.368, 93.859, 
...
df = pd.read_csv('/Users/prithwishghosh/Downloads/Breast_final.csv')
...
# Create subplot and pie chart
fig1, ax1 = plt.subplots()
ax1.pie(df['Status'].value_counts(), colors=[green, blue], labels=[ 'B', 'M'], autopct='%1.1f%%', startangle=0, rotatelabels=False)
...
# Data
ml_algorithms = ['XGboost',  'CNN', 'AdaBoost', 
                 'Adaptive Decision Learner', 'LSTM', 'Random Forest', 
                 'SVM', 'Logistic Regression']
accuracy_scores = [89.79,  85.3,  88.9, 
                   84.4, 89.56, 90.12, 89.89, 88.5]
